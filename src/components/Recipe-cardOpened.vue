...
<template>
  <div class="modal-recipe-card-top">
    ...
    <button class="modal-recipe-card-top__btn-close-modal" @click="closeRecipeCard"><img src="/svg/icon-close.svg"
        alt="Закрыть"></button>
  </div>
  <div class="modal-recipe-card-middle">
    <div class="modal-recipe-card-middle__information">
      ...
      <div class="modal-recipe-card-middle__information__text">
        <div class="modal-recipe-card-middle__information__text__item">
          ...
          <span class="modal-recipe-card-middle__information__text__item__span p-1">{{ item.properties.calorific }}</span>
        </div>
        <div class="modal-recipe-card-middle__information__text__item">
          <img src="/svg/icon-time.svg" alt="Время приготовления" class="properties-item__img">
          <span class="modal-recipe-card-middle__information__text__item__span p-1">{{ item.properties.time }}</span>
        </div>
        <div class="modal-recipe-card-middle__information__text__item">
        ...
        <div class="modal-recipe-card-middle__information__text__item">
          ...
          <span class="modal-recipe-card-middle__information__text__item__span p-1">{{ item.properties.protein }}</span>
        </div>
        <div class="modal-recipe-card-middle__information__text__item">
          <img src="/svg/icon-fat.svg" alt="Жиры" class="properties-item__img">
          <span class="modal-recipe-card-middle__information__text__item__span p-1">{{ item.properties.fats }}</span>
        </div>
        <div class="modal-recipe-card-middle__information__text__item">
          <img src="/svg/icon-carbohydrates.svg" alt="Жиры" class="properties-item__img">
          <span class="modal-recipe-card-middle__information__text__item__span p-1">{{ item.properties.carbohydrates
          }}</span>
        </div>
      </div>
    </div>
    <div class="modal-recipe-card-middle__information modal-recipe-card-middle__information_right">
      ...
      <ol class="modal-recipe-card-middle__information__text__ingredients-wrapper">
        <li class="modal-recipe-card-middle__information__text__item__span p-1" v-for="item in item.ingredients">- {{ item.name }} - {{ item.amount }}</li>
      </ol>
    </div>
  </div>
